    ...
    <div className="card-side side-back">
      <div className="container-fluid">
        <Card className={classes.root}>
          <CardContent>
            <Typography className={classes.backside} style={{overflowY:"auto",height:130,display: "flex", justifyContent:"space-between"}}>
              {info.description_text}
            </Typography>
            <Divider />
            {info.stock.available
              ? (
                <Typography variant="h5" color="textSecondary" component="h4" style={{color:"green"}}>
                  Available In Stock
                </Typography>
              )
              : (
                <Typography variant="h5" color="textSecondary" component="h4" style={{color:"red"}}>
                  Out Of Stock
                </Typography>
              )}
            <Divider />
